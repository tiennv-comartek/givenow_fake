...
function projectDetails() {
  ...
  return (
    <div className="detail_page ">
      ...
      <div className="py-10 grid lg:grid-cols-5 lg:px-24 px-10 grid-cols-1">
        ...
        <div className="pl-6 col-span-3 ">
          ...
          <div className=" rounded-md p-7 bg-gray-100 ">
            ...
            <div className="flex items-center text-lg mt-3">
              <UserOutlined /> &emsp;{item?.supporter?.length} người ủng hộ
            </div>
          ...
          <div className="grid grid-cols-2 text-xl gap-3 mt-3 text-white">
            <button className="bg-red-600 py-1 rounded-md">Ủng hộ ngay</button>
            <button className="bg-sky-400 py-1 rounded-md">
              Trở thành sử giả
            </button>
          </div>
        </div>
      ...
      <div className=" lg:mx-24 mx-10 ">
        <div className="flex border-b border-gray-200">
          <div
            className={`py-3 px-5 font-semibold  mr-5 rounded-t-md 
          ${
            tab === "content"
          ...
          <div
            className={`py-3 px-5 font-semibold rounded-t-md
                  ${
                    tab === "supporter"
                      ? "bg-blue-500 text-white"
                      : "text-gray-light bg-gray-100"
